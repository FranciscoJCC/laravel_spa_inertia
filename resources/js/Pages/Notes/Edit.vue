                        ...
                        <div class="shadow bg-white md:rounded-md p-4">
                            <form @submit.prevent="submit">
                                ...
                                <button
                                    ...
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 my-2"
                                >
                                    Actualizar
                                </button>
                               
                            </form>
                             <button href="#" class="bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-4 my-2 mx-2" @click="destroy">
                                Eliminar
                            </button>
                        </div>
                    </div>
